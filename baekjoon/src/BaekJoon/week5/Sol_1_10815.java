...
public class Sol_1_10815 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<Integer, Integer> card = new HashMap<>(0, n);
        ...
        for (int i = 0; i < k; i ++) {
            if (card.containsKey(Integer.parseInt(st.nextToken()))) bw.write("1 ");
            else bw.write("0 ");
        }
        bw.flush();
        bw.close();
